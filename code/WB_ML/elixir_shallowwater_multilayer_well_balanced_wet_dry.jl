...
# The domain of interest [0.0, 100.0] is extended towards [-28.0, 100.0] to match the positions of 
# the discontinuities with TreeMesh. Requires initial_refinement_level>=7 to resolve the 
# discontinuities.
